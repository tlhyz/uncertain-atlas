...
- 不变量 827；语料 C804；模式 name-the-nonrp-notraw-bar；反模式 nonrp-notraw-sold-as-bundled；L10.3 第 796 条。填 L4.4 / CometBFT 档案 vote_extension 会包进 CanonicalVoteExtension 不是已经按原样签 not already raw-signed / not already canon-vote / not already settled 正式三事（358 余量） / 实现表 / 05b / 共识专题 / 停链面地图。358 nonrp vs wrapped bundled unbundling 启动（827 item 1）。
...
- 不变量 809；语料 C786；模式 name-the-lateext-notverified-bar；反模式 lateext-notverified-sold-as-bundled；L10.3 第 778 条。填 L4.4 / CometBFT 档案 +2/3 之后才进来的扩展写进了 commit info 不是已经 Verify 过 not already verified / not already accept / not already later-verified 正式三事（352 余量） / 实现表 / 05b / 共识专题 / 停链面地图。352 lateext vs verified bundled unbundling 启动（809 item 1）。
...
- 不变量 802；语料 C779；模式 name-the-req9-notextstate-bar；反模式 req9-notextstate-sold-as-bundled；L10.3 第 771 条。填 L4.4 / CometBFT 档案 Extend 和 Verify 不得改已提交状态不是已经签了扩展就已经进状态 not already into-state / not already verified-in / not already ve-dep-34 正式三事（349 余量） / 实现表 / 05b / 共识专题 / 停链面地图。349 req9 vs commit bundled unbundling 完成（802 item 3）。
...
- 不变量 707；语料 C684；模式 name-the-exectxresult-notorder-bar；反模式 exectxresult-notorder-sold-as-bundled；L10.3 第 676 条。填 L4.4 / CometBFT 档案结果列表不是已经同一顺序 not already same order / not already count-implies-order / not already engine-ordered 正式三事（316 余量）/ 实现表 / 05b / 共识专题 / 停链面地图。316 exectxresult vs consensus bundled unbundling 启动（707 item 1）。
...
- 不变量 695；语料 C672；模式 name-the-checktxstate-notexecute-bar；反模式 checktxstate-notexecute-sold-as-bundled；L10.3 第 664 条。填 L4.4 / CometBFT 档案 CheckTxState 不是已经按 ExecuteTxState 验过 not already checked against ExecuteTxState / not already checked against to-be-executed state / not already same as ExecuteTxState after reset 正式三事（312 余量）/ 实现表 / 05b / 共识专题 / 停链面地图。312 checktxstate vs execute bundled unbundling 启动（695 item 1）。
...
- 不变量 679；语料 C656；模式 name-the-commitretaincaution-notpersist-bar；反模式 commitretaincaution-notpersist-sold-as-bundled；L10.3 第 648 条。填 L4.4 / CometBFT 档案 Historical blocks required for auditing replay light client not Use retain_height with caution / not If all nodes remove historical blocks / not Commit Usage persist signal bundled 正式三事（491 余量）/ 实现表 / 05b / 共识专题 / 停链面地图。491 commitretaincaution vs kept bundled unbundling 完成（679 item 3）。
