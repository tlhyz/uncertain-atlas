...
- 不变量 1329；语料 C1307；模式 name-the-vwcall-notrecv-bar；反模式 vwcall-notrecv-sold-as-bundled；L10.3 第 1298 条。填 L4.4 VerifyCall recv not already local-also-Verify / not already ExtendVote-When / not already late-MAY 正式三事（515 余量）。515 VerifyVoteExtension When call bundled unbundling 续（1329 item 2）。

## 2026-09-18（续 1445）

- 不变量 1328；语料 C1306；模式 name-the-vwcall-notcall-bar；反模式 vwcall-notcall-sold-as-bundled；L10.3 第 1297 条。填 L4.4 VerifyCall call not already Verify-When / not already verified / not already Accept 正式三事（515 余量）。515 VerifyVoteExtension When call bundled unbundling 启动（1328 item 1）。
...
- 不变量 1317；语料 C1295；模式 name-the-sugval-notcall-bar；反模式 sugval-notcall-sold-as-bundled；L10.3 第 1286 条。填 L4.4 SuggestValidate same-manner not already step-2-call / not already Verify-When / not already MUST-det 正式三事（520 余量）。520 PrepareProposal When suggestvalidate bundled unbundling 续（1317 item 2）。

## 2026-09-18（续 1433）

- 不变量 1316；语料 C1294；模式 name-the-sugval-notmust-bar；反模式 sugval-notmust-sold-as-bundled；L10.3 第 1285 条。填 L4.4 SuggestValidate suggested not already late-ext / not already engine-re-Verify / not already Accept 正式三事（520 余量）。520 PrepareProposal When suggestvalidate bundled unbundling 启动（1316 item 1）。
...
- 不变量 1062；语料 C1040；模式 name-the-finrestr-notpunish-bar；反模式 finrestr-notpunish-sold-as-bundled；L10.3 第 1031 条。填 L4.4 / CometBFT 档案 FinalizeBlockRequest.misbehavior not already rewarded / not already process-mis / not already settled 正式三事（428 余量）。428 finreqrest vs procreq bundled unbundling 续（1062 item 2）。

## 2026-09-18（续 1178）

- 不变量 1061；语料 C1039；模式 name-the-finrestr-nothash-bar；反模式 finrestr-nothash-sold-as-bundled；L10.3 第 1030 条。填 L4.4 / CometBFT 档案 FinalizeBlockRequest.hash not already process-hash / not already processed / not already settled 正式三事（428 余量）。428 finreqrest vs procreq bundled unbundling 启动（1061 item 1）。

## 2026-09-18（续 1177）

- 不变量 1060；语料 C1038；模式 name-the-procend-notprelim-bar；反模式 procend-notprelim-sold-as-bundled；L10.3 第 1029 条。填 L4.4 / CometBFT 档案 PrepareProposalResponse.txs not already preliminary / not already same-round / not already settled 正式三事（427 余量）。427 procreqend vs prepreq bundled unbundling 完成（1060 item 3）。

## 2026-09-18（续 1176）

- 不变量 1059；语料 C1037；模式 name-the-procend-notmaking-bar；反模式 procend-notmaking-sold-as-bundled；L10.3 第 1028 条。填 L4.4 / CometBFT 档案 ProcessProposalRequest.proposer_address not already making / not already header-known / not already settled 正式三事（427 余量）。427 procreqend vs prepreq bundled unbundling 续（1059 item 2）。

## 2026-09-18（续 1175）

- 不变量 1058；语料 C1036；模式 name-the-procend-nothash-bar；反模式 procend-nothash-sold-as-bundled；L10.3 第 1027 条。填 L4.4 / CometBFT 档案 ProcessProposalRequest.next_validators_hash not already prepare-hash / not already finalize-hash / not already settled 正式三事（427 余量）。427 procreqend vs prepreq bundled unbundling 启动（1058 item 1）。

## 2026-09-18（续 1174）

- 不变量 1057；语料 C1035；模式 name-the-preprend-notts-bar；反模式 preprend-notts-sold-as-bundled；L10.3 第 1026 条。填 L4.4 / CometBFT 档案 FinalizeBlockRequest.time not already header-aligned / not already prepare-time / not already settled 正式三事（426 余量）。426 prepreqend vs finreq bundled unbundling 完成（1057 item 3）。

## 2026-09-18（续 1173）

- 不变量 1056；语料 C1034；模式 name-the-preprend-notmade-bar；反模式 preprend-notmade-sold-as-bundled；L10.3 第 1025 条。填 L4.4 / CometBFT 档案 PrepareProposalRequest.proposer_address not already made / not already header-known / not already settled 正式三事（426 余量）。426 prepreqend vs finreq bundled unbundling 续（1056 item 2）。

## 2026-09-18（续 1172）

- 不变量 1055；语料 C1033；模式 name-the-preprend-nothash-bar；反模式 preprend-nothash-sold-as-bundled；L10.3 第 1024 条。填 L4.4 / CometBFT 档案 PrepareProposalRequest.next_validators_hash not already finalize-hash / not already rotated / not already settled 正式三事（426 余量）。426 prepreqend vs finreq bundled unbundling 启动（1055 item 1）。
...
- 不变量 1026；语料 C1004；模式 name-the-procreq-notproc-bar；反模式 procreq-notproc-sold-as-bundled；L10.3 第 995 条。填 L4.4 / CometBFT 档案 ProcessProposalRequest.hash not already processed / not already ext-hash / not already settled 正式三事（419 余量）。419 procreq vs extreq bundled unbundling 续（1026 item 2）。

## 2026-09-17（续 1142）

- 不变量 1025；语料 C1003；模式 name-the-procreq-notexec-bar；反模式 procreq-notexec-sold-as-bundled；L10.3 第 994 条。填 L4.4 / CometBFT 档案 ProcessProposalRequest.txs not already executed / not already whole-block / not already settled 正式三事（419 余量）。419 procreq vs extreq bundled unbundling 启动（1025 item 1）。
...
- 不变量 957；语料 C935；模式 name-the-snapshot-discover-nottake-bar；反模式 snapshot-discover-nottake-sold-as-bundled；L10.3 第 926 条。填 L4.4 / CometBFT 档案 挑了最高 not already offered / not already restored / not already settled 正式三事（322 余量）。322 snapshot-discover vs offer bundled unbundling 续（957 item 2）。

## 2026-09-17（续 1073）

- 不变量 956；语料 C934；模式 name-the-snapshot-discover-notfull-bar；反模式 snapshot-discover-notfull-sold-as-bundled；L10.3 第 925 条。填 L4.4 / CometBFT 档案 ListSnapshots 回了 not already all-snapshots / not already unbounded / not already settled 正式三事（322 余量）。322 snapshot-discover vs offer bundled unbundling 启动（956 item 1）。
...
- 不变量 891；语料 C869；模式 name-the-verify-det-nothonest-bar；反模式 verify-det-nothonest-sold-as-bundled；L10.3 第 860 条。填 L4.4 / CometBFT 档案 两边对任意扩展同一裁决 not already only honest same verdict / not already Req 6 honest Accept / not already settled 正式三事（341 余量）。341 verify-det vs extend bundled unbundling 续（891 item 2）。

## 2026-09-17（续 1007）

- 不变量 890；语料 C868；模式 name-the-verify-det-notext-bar；反模式 verify-det-notext-sold-as-bundled；L10.3 第 859 条。填 L4.4 / CometBFT 档案 Verify 必须只依赖扩展、这块和上一份状态 not already ExtendVote-style other values / not already same ruler as ExtendVote / not already settled 正式三事（341 余量）。341 verify-det vs extend bundled unbundling 启动（890 item 1）。
...
- 不变量 873；语料 C851；模式 name-the-req3-notbyz-bar；反模式 req3-notbyz-sold-as-bundled；L10.3 第 842 条。填 L4.4 / CometBFT 档案 Prepare 或 Process 里有确定 bug 会让踩中的人算拜占庭 not already only liveness / not already Process nondet / not already settled 正式三事（347 余量）。347 req3 vs accept bundled unbundling 续（873 item 2）。

## 2026-09-17（续 989）

- 不变量 872；语料 C850；模式 name-the-req3-notany-bar；反模式 req3-notany-sold-as-bundled；L10.3 第 841 条。填 L4.4 / CometBFT 档案 正确提议者的准备提案必须被正确接收者 Accept not already any block Accepts / not already default Accept / not already settled 正式三事（347 余量）。347 req3 vs accept bundled unbundling 启动（872 item 1）。
...
- 不变量 666；语料 C643；模式 name-the-infousage-notlaneoptional-bar；反模式 infousage-notlaneoptional-sold-as-bundled；L10.3 第 635 条。填 L4.4 / CometBFT 档案 Info Usage does not have to define lane_priorities not Info 车道 bundled / not CheckTx empty lane_id default lane / not CheckTx Priority consensus order 正式三事（497 余量）/ 实现表 / 05b / 共识专题 / 停链面地图。497 infousage persist/lane unbundling 续（666 item 2）。
...
- 不变量 654；语料 C631；模式 name-the-applysnapusage-notinfo-bar；反模式 applysnapusage-notinfo-sold-as-bundled；L10.3 第 623 条。填 L4.4 / CometBFT 档案 ApplySnapshotChunk Usage all chunks accepted 后 Info not Info during load / not Transition to Consensus bundled / not verified AppHash at end 正式三事（485 余量）/ 实现表 / 05b / 共识专题 / 停链面地图。485 applysnapusage unbundling 续（654 item 2）。
...
- 不变量 628；语料 C605；模式 name-the-fintxcode-notsettled-bar；反模式 fintxcode-notsettled-sold-as-bundled；L10.3 第 597 条。填 L4.4 / CometBFT 档案 FinalizeBlockResponse tx_results returned not Finalize changed already settled / not Code Data printed in this header LastResultsHash / not fintxcode bundled 正式三事（585 余量）/ 实现表 / 05b / 共识专题 / 停链面地图。585 fintxcode unbundling 完成（628 item 3）。
...
- 不变量 623；语料 C600；模式 name-the-finmerkle-notthisheader-bar；反模式 finmerkle-notthisheader-sold-as-bundled；L10.3 第 592 条。填 L4.4 / CometBFT 档案 FinalizeBlockResponse app_hash optional Merkle root not this header AppHash / not settled / not finmerkle bundled 正式三事（475 余量）/ 实现表 / 05b / 共识专题 / 停链面地图。475 finmerkle unbundling 启动（623 item 1）。
...
- 不变量 603；语料 C580；模式 name-the-finequiv-notnoprep-bar；反模式 finequiv-notnoprep-sold-as-bundled；L10.3 第 572 条。填 L4.4 / CometBFT 档案 FinalizeBlock equiv ABCI 1.0 not no Prepare/Process 正式三事（586 余量）/ 实现表 / 05b / 共识专题 / 停链面地图。586 finequiv unbundling 续（603 item 2）。
...
- 不变量 589；语料 C566；模式 name-the-fndelay-bar；反模式 fndelay-sold-as-slot；L10.3 第 558 条。填 L4.4 / CometBFT 档案 FinalizeBlockResponse next_block_delay 非确定正式三事 / 实现表 / 05b / 共识专题 / 停链面地图。remote 469 → local 589。更新 finmorepre / findet / consensus 等处 forward ref 469→589。
...
- 不变量 568；语料 C560；模式 name-the-findecided-notproposed-bar；反模式 findecided-notproposed-sold-as-bundled；L10.3 第 552 条。填 L4.4 / CometBFT 档案 FinalizeBlock decided_last_commit from decided block not proposed_last_commit 正式三事 / 实现表 / 05b / 共识专题 / 停链面地图。463 finreward unbundling 续（568 item 2）。
...
- 不变量 564；语料 C556；模式 name-the-finfill-notdecprop-bar；反模式 finfill-notdecprop-sold-as-bundled；L10.3 第 548 条。填 L4.4 / CometBFT 档案 FinalizeBlock fill all fields not decided/proposed interchangeable 正式三事（473 余量）/ 实现表 / 05b / 共识专题 / 停链面地图。473 fill all fields even if Prepare/Process passed unbundling 完成（562–564）。
...
- 不变量 561；语料 C553；模式 name-the-finnewdec-notmatchheader-bar；反模式 finnewdec-notmatchheader-sold-as-bundled；L10.3 第 545 条。填 L4.4 / CometBFT 档案 FinalizeBlock Contains newly decided block fields not match header 正式三事（474 余量）/ 实现表 / 05b / 共识专题 / 停链面地图。474 Contains newly decided block fields unbundling 完成（559–561）。

## 2026-09-16（续 692）

- 不变量 560；语料 C552；模式 name-the-finnewdec-notproposed-bar；反模式 finnewdec-notproposed-sold-as-bundled；L10.3 第 544 条。填 L4.4 / CometBFT 档案 FinalizeBlock newly decided block not proposed block 正式三事（474 余量）/ 实现表 / 05b / 共识专题 / 停链面地图。474 Contains newly decided block fields unbundling 续（560）。
...
- 不变量 557；语料 C549；模式 name-the-finnewfields-notprocfull-bar；反模式 finnewfields-notprocfull-sold-as-bundled；L10.3 第 541 条。填 L4.4 / CometBFT 档案 FinalizeBlock newly decided block fields not ProcessProposal contains all information 正式三事 / 实现表 / 05b / 共识专题 / 停链面地图。461 FinalizeBlock 含刚决定那块字段 unbundling 续（557）。

## 2026-09-16（续 688）

- 不变量 556；语料 C548；模式 name-the-finnewfields-notsettled-bar；反模式 finnewfields-notsettled-sold-as-bundled；L10.3 第 540 条。填 L4.4 / CometBFT 档案 FinalizeBlock Contains newly decided block fields not already settled 正式三事 / 实现表 / 05b / 共识专题 / 停链面地图。461 FinalizeBlock 含刚决定那块字段 unbundling 启动（556）。

## 2026-09-16（续 687）

- 不变量 555；语料 C547；模式 name-the-finht-notprocht-bar；反模式 finht-notprocht-sold-as-bundled；L10.3 第 539 条。填 L4.4 / CometBFT 档案 FinalizeBlock Finalize match header not ProcessProposal match 正式三事 / 实现表 / 05b / 共识专题 / 停链面地图。462 FinalizeBlock height/time 对上拟议块头 unbundling 完成（553–555）。

## 2026-09-16（续 686）

- 不变量 554；语料 C546；模式 name-the-finhtreqlht-notusage-bar；反模式 finhtreqlht-notusage-sold-as-bundled；L10.3 第 538 条。填 L4.4 / CometBFT 档案 FinalizeBlock Request height/time 栏 not Usage match 正式三事 / 实现表 / 05b / 共识专题 / 停链面地图。462 FinalizeBlock height/time 对上拟议块头 unbundling 续（554）。
...
- 不变量 549；语料 C541；模式 name-the-procfull-notfinfields-bar；反模式 procfull-notfinfields-sold-as-bundled；L10.3 第 533 条。填 L4.4 / CometBFT 档案 ProcessProposal Contains all information not Finalize newly decided fields 正式三事 / 实现表 / 05b / 共识专题 / 停链面地图。453 ProcessProposal 含执行所需全部信息 unbundling 完成（547–549）。

## 2026-09-15（续 680）

- 不变量 548；语料 C540；模式 name-the-procfull-req8-notprepare-bar；反模式 procfull-req8-notprepare-sold-as-bundled；L10.3 第 532 条。填 L4.4 / CometBFT 档案 ProcessProposal Request 八栏齐 not only Prepare txs 正式三事 / 实现表 / 05b / 共识专题 / 停链面地图。453 ProcessProposal 含执行所需全部信息 unbundling 续（548）。
...
- 不变量 545；语料 C537；模式 name-the-proccand-mayexecute-notcommitted-bar；反模式 proccand-mayexecute-notcommitted-sold-as-bundled；L10.3 第 529 条。填 L4.4 / CometBFT 档案 ProcessProposal MAY fully execute not already committed 正式三事 / 实现表 / 05b / 共识专题 / 停链面地图。452 ProcessProposal 候选执行 unbundling 续（545）。
...
- 不变量 542；语料 C534；模式 name-the-verifystatus-accept-bar；反模式 verifystatus-accept-sold-as-bundled；L10.3 第 526 条。填 L4.4 / CometBFT 档案 VerifyStatus ACCEPT accepts vote 正式三事 / 实现表 / 05b / 共识专题 / 停链面地图。434 VerifyStatus unbundling 续（542）。

## 2026-09-15（续 673）

- 不变量 541；语料 C533；模式 name-the-verifystatus-unknown-bar；反模式 verifystatus-unknown-sold-as-bundled；L10.3 第 525 条。填 L4.4 / CometBFT 档案 VerifyStatus UNKNOWN always wrong 正式三事 / 实现表 / 05b / 共识专题 / 停链面地图。434 VerifyStatus unbundling 启动（541）。
...
- 不变量 538；语料 C530；模式 name-the-procrespstatus-exclusivedep-bar；反模式 procrespstatus-exclusivedep-sold-as-bundled；L10.3 第 522 条。填 L4.4 / CometBFT 档案 ProcessProposal Response status must exclusively depend 正式三事 / 实现表 / 05b / 共识专题 / 停链面地图。430 Process 回包栏 unbundling 续（538）。
...
- 不变量 535；语料 C527；模式 name-the-procreject-prevote-notverify-bar；反模式 procreject-prevote-notverify-sold-as-bundled；L10.3 第 519 条。填 L4.4 / CometBFT 档案 ProcessProposal REJECT prevote nil not Verify whole vote 正式三事 / 实现表 / 05b / 共识专题 / 停链面地图。533 Process REJECT consensus assume unbundling 续（535）。

## 2026-09-15（续 666）

- 不变量 534；语料 C526；模式 name-the-procreject-assume-notblockinvalid-bar；反模式 procreject-assume-notblockinvalid-sold-as-bundled；L10.3 第 518 条。填 L4.4 / CometBFT 档案 ProcessProposal REJECT consensus assumes not valid not block invalid 正式三事 / 实现表 / 05b / 共识专题 / 停链面地图。533 Process REJECT consensus assume unbundling 启动（534）。
...
- 不变量 530；语料 C522；模式 name-the-procaccept-shouldaccept-bar；反模式 procaccept-shouldaccept-sold-as-bundled；L10.3 第 514 条。填 L4.4 / CometBFT 档案 ProcessProposal Usage SHOULD always set ACCEPT 正式三事 / 实现表 / 05b / 共识专题 / 停链面地图。

## 2026-09-15（续 661）

- 不变量 529；语料 C521；模式 name-the-verifyaccept-default-bar；反模式 verifyaccept-default-sold-as-bundled；L10.3 第 513 条。填 L4.4 / CometBFT 档案 VerifyVoteExtension Usage SHOULD Accept default strategy 正式三事 / 实现表 / 05b / 共识专题 / 停链面地图。

## 2026-09-15（续 660）

- 不变量 528；语料 C520；模式 name-the-verifyaccept-liveness-bar；反模式 verifyaccept-liveness-sold-as-bundled；L10.3 第 512 条。填 L4.4 / CometBFT 档案 VerifyVoteExtension Usage unless really know liveness implications 正式三事 / 实现表 / 05b / 共识专题 / 停链面地图。
...
- 不变量 525；语料 C517；模式 name-the-extusage-zerolen-bar；反模式 extusage-zerolen-sold-as-bundled；L10.3 第 509 条。填 L4.4 / CometBFT 档案 ExtendVote Usage application can choose 0-length extension 正式三事 / 实现表 / 05b / 共识专题 / 停链面地图。
...
- 不变量 515；语料 C507；模式 name-the-verifywhen-call-bar；反模式 verifywhen-call-sold-as-bundled；L10.3 第 499 条。填 L4.4 / CometBFT 档案 VerifyVoteExtension When call VerifyVoteExtension 正式三事 / 实现表 / 05b / 共识专题 / 停链面地图。
...
- 不变量 510；语料 C502；模式 name-the-extwhen-fill-bar；反模式 extwhen-fill-sold-as-bundled；L10.3 第 494 条。填 L4.4 / CometBFT 档案 ExtendVote When fill CanonicalVoteExtension 正式三事 / 实现表 / 05b / 共识专题 / 停链面地图。

## 2026-09-15（续 641）

- 不变量 509；语料 C501；模式 name-the-extwhen-return-bar；反模式 extwhen-return-sold-as-bundled；L10.3 第 493 条。填 L4.4 / CometBFT 档案 ExtendVote When return extension 正式三事 / 实现表 / 05b / 共识专题 / 停链面地图。

## 2026-09-15（续 640）

- 不变量 508；语料 C500；模式 name-the-extwhen-call-bar；反模式 extwhen-call-sold-as-bundled；L10.3 第 492 条。填 L4.4 / CometBFT 档案 ExtendVote When call / synchronous 正式三事 / 实现表 / 05b / 共识专题 / 停链面地图。
...
- 不变量 499；语料 C491；模式 name-the-offersnapusage-bootstrap-bar；反模式 offersnapusage-bootstrap-sold-as-bundled；L10.3 第 483 条。填 L4.4 / CometBFT 档案 OfferSnapshot Usage bootstrap accept/reject 正式三事 / 实现表 / 05b / 共识专题 / 停链面地图。
...
- 不变量 487；语料 C479；模式 name-the-queryusage-bar；反模式 queryusage-sold-as-querystate；L10.3 第 471 条。填 L4.4 / CometBFT 档案 Query Usage 正式三事 / 实现表 / 05b / 共识专题 / 停链面地图。
...
- 不变量 577；语料 C458；模式 name-the-fincand-notcandstate-bar；反模式 fincand-notcandstate-sold-as-bundled；L10.3 第 450 条。填 L4.4 / CometBFT 档案 apply candidate state not ExecuteTxState 正式三事（460 余量）/ 实现表 / 05b / 共识专题 / 停链面地图。460 FinalizeBlock 套用候选 unbundling 续（577 item 2）。
...
- 不变量 466；语料 C453；模式 name-the-finexecbv-bar；反模式 finexecbv-sold-as-bundled；L10.3 第 445 条。填 L4.4 / CometBFT 档案 FinalizeBlock When Application executes block v / 实现表 / 05b / 共识专题 / 停链面地图。466 finexecbv parent bundled 启动。

## 2026-09-14（续 592）

- 不变量 572；语料 C452；模式 name-the-finwhen-notexecbv-bar；反模式 finwhen-notexecbv-sold-as-bundled；L10.3 第 444 条。填 L4.4 / CometBFT 档案 FinalizeBlock When calling ProcessProposal guarantee not executes block v / persist decision 正式三事（472 余量）/ 实现表 / 05b / 共识专题 / 停链面地图。472 finwhen unbundling 完成（570 + 571 + 572 + parent 472）。
...
- 不变量 568；语料 C446；模式 name-the-finfill-notpassed-bar；反模式 finfill-notpassed-sold-as-bundled；L10.3 第 438 条。填 L4.4 / CometBFT 档案 FinalizeBlock fill all fields not passed means ran Process 正式三事（473 余量）/ 实现表 / 05b / 共识专题 / 停链面地图。473 finfill unbundling 续（568 item 2）。
