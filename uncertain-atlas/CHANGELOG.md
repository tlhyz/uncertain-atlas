...
- 不变量 691；语料 C668；模式 name-the-commitlock-notbroadcast-bar；反模式 commitlock-notbroadcast-sold-as-bundled；L10.3 第 660 条。填 L4.4 / CometBFT 档案 Commit wait broadcast_tx not already can proceed / not receipt already settled / not sync call already allowed 正式三事（310 余量） / 实现表 / 05b / 共识专题 / 停链面地图。310 commitlock vs RPC bundled unbundling 完成（689 + 690 + 691）。
