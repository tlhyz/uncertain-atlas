...
| libraries | design-patterns ~540；anti-patterns ~650；invariants ~874；corpus C852+ | 见 [`index/03-knowledge-assets.md`](index/03-knowledge-assets.md) |
...
| ABCI++ 不变量未拆完（~874/793） | Phase 1 继续流水线 |
