...
| 轨 | 状态 | 约数 |
|---|---|---|
| index | 已立；含 [`05-optimization-roadmap.md`](index/05-optimization-roadmap.md) + [`06-snapshot-branches.md`](index/06-snapshot-branches.md) | 7 文件 |
...
| libraries | design-patterns ~540；anti-patterns ~650；invariants ~1409；corpus C1387+ | 见 [`index/03-knowledge-assets.md`](index/03-knowledge-assets.md) |
...
| tools | adversarial_runner + atlas_index + invariant_corpus_links + snapshot_branch_inventory | [`tools/`](tools/README.md) |
...
| 缺口 | 计划 |
|---|---|
| 285 cometbft 快照：211 祖先 / 74 平行 / 107 缺失；unique 9 簇开始回收 | Phase 3 不删 remote；见 index/06 |
| ABCI++ 不变量未拆完（~1409/793） | Phase 1 继续流水线 |
