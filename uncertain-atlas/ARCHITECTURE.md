...
| libraries | design-patterns ~540；anti-patterns ~650；invariants ~1186；corpus C1164+ | 见 [`index/03-knowledge-assets.md`](index/03-knowledge-assets.md) |
...
| ABCI++ 不变量未拆完（~1186/793） | Phase 1 继续流水线 |
