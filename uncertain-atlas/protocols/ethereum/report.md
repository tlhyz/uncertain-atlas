...
合并前工作量难度把叔块算进目标，不是已经按个数调，也不是已经没有炸弹：[`../../tracks/consensus/worked-example-uncle-diff-vs-header.md`](../../tracks/consensus/worked-example-uncle-diff-vs-header.md)（不变量 238）。
