...
3. **fill all fields not request complete means committed 不是 finfields / finpersist bundled：** 看见请求齐了 不是已经交差，不是 407 finfields interchangeable / 335 finpersist interchangeable / 566 not request complete means committed interchangeable / 584 apply candidate interchangeable。
