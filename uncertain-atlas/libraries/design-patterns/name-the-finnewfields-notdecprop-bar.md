...
2. **fill all fields not newly decided/proposed interchangeable 不是 359 Prepare 同一套字段：** 看见 even if passed 不是已经 newly decided 和 proposed interchangeable，不是 461 bundled interchangeable / 359 Prepare 同一套 interchangeable / 556 not ProcessProposal full info interchangeable。
