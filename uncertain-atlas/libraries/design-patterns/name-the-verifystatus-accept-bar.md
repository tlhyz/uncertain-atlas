...
1. **ACCEPT accepts vote not block invalid 不是 VerifyStatus bundled：** 看见回了 ACCEPT 不是已经当成块非法，不是 434 bundled interchangeable / 34 whole precommit invalid interchangeable / 539 valid/invalid interchangeable。
