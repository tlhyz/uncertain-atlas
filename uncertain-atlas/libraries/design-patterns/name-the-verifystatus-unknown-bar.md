...
1. **UNKNOWN always wrong not already verified 不是 VerifyStatus bundled：** 看见回了 UNKNOWN 不是已经验过扩展，不是 434 bundled interchangeable / 539 valid/invalid interchangeable / 516 When return interchangeable。
