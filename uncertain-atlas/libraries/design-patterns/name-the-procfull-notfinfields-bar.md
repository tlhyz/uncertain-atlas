...
3. **Contains all information not only txs enough 不是 Request 八栏齐 only txs：** 看见含执行所需全部信息不是已经只有 txs 字段就够 fully execute，不是 453 bundled interchangeable / 547 only txs enough interchangeable / 419 Process req txs interchangeable。
