...
2. **REJECT rejects whole vote not block invalid 不是 Process prevote nil：** 看见 rejects whole vote，不是 433 bundled interchangeable / 533 prevote nil interchangeable / 34 block invalid interchangeable。
