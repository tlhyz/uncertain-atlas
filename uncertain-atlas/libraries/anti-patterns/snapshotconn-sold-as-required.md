...
- [snapshotconn-notgone-sold-as-bundled](snapshotconn-notgone-sold-as-bundled.md) 是应用选择不实现不是已经没有 state sync 这条对象 item 3 单句边界，不是本页 Snapshot Connection bundled 全段。
