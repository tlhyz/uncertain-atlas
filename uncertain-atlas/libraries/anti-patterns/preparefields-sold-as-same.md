...
- [prepfields-notthissigned-sold-as-bundled](prepfields-notthissigned-sold-as-bundled.md) 是 local_last_commit 上一高 not already this-signed / not already ve-at-h / not already settled 正式三事（359 item 2），不是本页 bundled 全段 alone。
- [prepfields-nothash-sold-as-bundled](prepfields-nothash-sold-as-bundled.md) 是拟议头三列 not already header-hash / not already execute / not already settled 正式三事（359 item 3），不是本页 bundled 全段 alone。
