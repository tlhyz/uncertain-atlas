...
- [retarget-nottraceable-sold-as-bundled](retarget-nottraceable-sold-as-bundled.md) 是把 t1 改成 t2 not already t1-lookup / not already origin-known / not already settled 正式三事（355 item 3），不是本页 bundled 全段 alone。
