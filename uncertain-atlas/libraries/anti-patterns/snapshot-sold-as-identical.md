...
- [snapident-notcomplete-sold-as-bundled](snapident-notcomplete-sold-as-bundled.md) 是空快照也至少 1 块 not already complete / not already consensus-const / not already restored 正式三事（368 item 3），不是本页 bundled 全段 alone。
