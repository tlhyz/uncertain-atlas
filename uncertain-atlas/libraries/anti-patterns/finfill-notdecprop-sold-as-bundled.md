...
- [finfill-notneedfinalize-sold-as-bundled](finfill-notneedfinalize-sold-as-bundled.md) 是 567 473 item 1 余量，不是本页 all fields not decided/proposed 单句边界。
- [finfill-notpassedran-sold-as-bundled](finfill-notpassedran-sold-as-bundled.md) 是 568 473 item 2 余量，不是本页 Prepare/Process passed means decided/proposed 边界。
- [finnewfields-notdecprop-sold-as-bundled](finnewfields-notdecprop-sold-as-bundled.md) 是 557 461 bundled item 3 余量，不是本页 473 bundled item 3 边界。
