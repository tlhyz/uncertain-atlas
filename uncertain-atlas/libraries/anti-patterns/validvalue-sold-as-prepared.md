...
- [vv-notraw-sold-as-bundled](vv-notraw-sold-as-bundled.md) 是没调 Prepare not already reap-again / not already new-raw / not already preparedrop 正式三事（356 item 3），不是本页 bundled 全段 alone。
