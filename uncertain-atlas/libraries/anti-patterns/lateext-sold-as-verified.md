...
- [lateext-notrecall-sold-as-bundled](lateext-notrecall-sold-as-bundled.md) 是下一高度 round 0 写进 ExtendedCommitInfo not already called-again / not already must-recall / not already this-round-verify 正式三事（352 item 3），不是本页 bundled 全段 alone。
