...
- [paramsdelay-notveheight-sold-as-bundled](paramsdelay-notveheight-sold-as-bundled.md) 是参数更新写了 H+1 不是已经是扩展启用高度那种切换 item 3 单句边界，不是本页 ConsensusParams 生效延迟 bundled 全段。
