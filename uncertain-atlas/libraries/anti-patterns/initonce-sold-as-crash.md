...
- [initchainusage-decide-sold-as-bundled](initchainusage-decide-sold-as-bundled.md) 是 InitChain Usage app decide / ValidatorUpdate from empty set 正式三事，不是本页 InitChain Usage 余量 bundled 三事。
