- [`queryprove-notkey-sold-as-bundled.md`](queryprove-notkey-sold-as-bundled.md) — 回了证明被写成已经是按键查 / 有序列化证明被写成已经对上 AppHash / 能回被写成已经交差（不变量 897）
- [`queryprove-notmatched-sold-as-bundled.md`](queryprove-notmatched-sold-as-bundled.md) — 勾了 prove 被写成已经对上 AppHash / 能回证明被写成已经是一层树 / 请求了被写成已经交差（不变量 896）
- [`syncingheight-notmustdet-sold-as-bundled.md`](syncingheight-notmustdet-sold-as-bundled.md) — 回了事件被写成已经必须确定 / 标成非确定被写成已经交差 / 能按类型键值索引被写成已经是结果列表同一顺序（不变量 895）
...
- [`checktxopt-notused-sold-as-bundled.md`](checktxopt-notused-sold-as-bundled.md) — 有码被写成已经被引擎用了 Data / 码在被写成已经是共识顺序 / 拒了被写成已经分叉（不变量 868）
...
- [`queryheight-notfresh-sold-as-bundled.md`](queryheight-notfresh-sold-as-bundled.md) — 没填被写成已经新鲜 / 回了最新已提交被写成已经跟上正在跑的块 / 默认 0 被写成已经是 Info 握手那两列（不变量 861）
...
- [`snapshotverify-notuniqueapphash-sold-as-bundled.md`](snapshotverify-notuniqueapphash-sold-as-bundled.md) — 增量验了 chunk 被写成已经是唯一可信的 AppHash / checksum 过了 被写成已经不能伪造元数据 / 证明绿了 被写成已经代替最后那次 Info（不变量 753）
