...
- [infover-nothandshake-sold-as-bundled](infover-nothandshake-sold-as-bundled.md) 是 abci_version 是 ABCI 语义版本、按 X.X.x 显示不是已经是握手对齐 not already handshake / not already priority / not already settled 正式三事（379 item 3），不是本页 bundled 全段 alone。
