...
- [abci20-notgenesiscfg-sold-as-bundled](abci20-notgenesiscfg-sold-as-bundled.md) 是引擎按当前高度决定存什么要什么 not already genesiscfg / not already app-decides / not already settled 正式三事（346 item 3），不是本页 bundled 全段 alone。
