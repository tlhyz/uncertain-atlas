...
- [extwhen-notsameext-sold-as-bundled](extwhen-notsameext-sold-as-bundled.md) 是回包不解释 not already same-ext / not already canon-ve / not already settled 正式三事（361 item 3），不是本页 bundled 全段 alone。
