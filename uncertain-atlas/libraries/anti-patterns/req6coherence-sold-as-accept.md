...
- [req6-notsafety-sold-as-bundled](req6-notsafety-sold-as-bundled.md) 是会面对和 Req 5 同一类活性问题 not already lost-safety / not already req3-same / not already proposal-path 正式三事（348 item 3），不是本页 bundled 全段 alone。
