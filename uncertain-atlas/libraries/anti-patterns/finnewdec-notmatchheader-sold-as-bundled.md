...
- [finnewdec-notsettled-sold-as-bundled](finnewdec-notsettled-sold-as-bundled.md) 是 564 Contains not settled，不是本页 fields vs match header 边界。
- [finnewdec-notproposed-sold-as-bundled](finnewdec-notproposed-sold-as-bundled.md) 是 565 newly decided not proposed，不是本页 474 item 3 边界。
