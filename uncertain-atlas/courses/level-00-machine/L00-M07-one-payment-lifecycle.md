...
**禁止假学习：** 「钱包绿勾指协议最终。」「进 mempool 就是上链。」「打开付款链接就是已验证。」「看见付款 URI 就是已经授权 / 已经付过。」  
**边界：** 各链细节在档案第 4 节。五列对照见 [`../../tracks/lifecycle/`](../../tracks/lifecycle/README.md)。付款 URI 远程取单 ≠ 验证：[`../../tracks/failure-museum/cve-2024-52918.md`](../../tracks/failure-museum/cve-2024-52918.md)。付款 URI 方案本身被写成已经授权是本页（不变量 255 / BIP-321），不是 55。
