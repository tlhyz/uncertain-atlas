...
| 0.7 | [L00-M07-one-payment-lifecycle.md](L00-M07-one-payment-lifecycle.md) | 一笔转账从点击到确认经过哪些门？看见付款 URI ≠ 已经授权（不变量 255）；看见签过的消息 ≠ 已经控制资金（不变量 258）；看见静默付款地址 ≠ 已经有输出（不变量 260）；看见可读名字 ≠ 已经该走 DNS（不变量 261） |
