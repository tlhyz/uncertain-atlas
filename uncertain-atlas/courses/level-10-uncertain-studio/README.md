...
覆盖声明：L10.1→M10.1；L10.2+L10.4→M10.2；L10.3→M10.6；M10.3→[`../../libraries/threat-model/`](../../libraries/threat-model/README.md)；M10.4→[`../../libraries/invariants/`](../../libraries/invariants/README.md)；M10.5→[`../../libraries/adversarial-corpus/`](../../libraries/adversarial-corpus/README.md)（C01–C103；实现仓库的 runner 未建）。
