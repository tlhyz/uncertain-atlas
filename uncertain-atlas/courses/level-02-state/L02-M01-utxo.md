...
付给脚本哈希不是已经揭开赎回脚本。旧节点 HASH160 EQUAL 通过不是新节点已经再跑。精读：[`../../tracks/state-models/worked-example-p2sh-hash-vs-redeem.md`](../../tracks/state-models/worked-example-p2sh-hash-vs-redeem.md) BIP-16 hash-output not already redeem-revealed / not already 297 / not already 170-bundled 正式三事（170 余量）：[`../../tracks/state-models/worked-example-phsh-notrev-vs-bundled.md`](../../tracks/state-models/worked-example-phsh-notrev-vs-bundled.md)（不变量 1533）。 BIP-16 old-equal not already new-reran / not already 153 / not already 144 正式三事（170 余量）：[`../../tracks/state-models/worked-example-phsh-notrun-vs-bundled.md`](../../tracks/state-models/worked-example-phsh-notrun-vs-bundled.md)（不变量 1534）。 BIP-16 hash-match not already inner-verified / not already 152 / not already 297 正式三事（170 余量）：[`../../tracks/state-models/worked-example-phsh-notinr-vs-bundled.md`](../../tracks/state-models/worked-example-phsh-notinr-vs-bundled.md)（不变量 1535）。（不变量 170）。
