...
| 7.2 | [L07-M02-data-availability.md](L07-M02-data-availability.md) | M7.2 | 有头为什么还不够 |
...
Polkadot / Kusama 事故：博物馆 2025-05 交易深度套错对象（不变量 97）；2025-08 组下标≠票下标（不变量 98）；2024-02 Active≠Confirmed（不变量 99）；2025-05-09 链下禁用≠已确认不参与（不变量 100）；2026-06 选举地板≠已配对（不变量 110）；2026-03 preserve_origin≠出站已绑（不变量 113）。
