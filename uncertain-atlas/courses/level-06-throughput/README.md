...
覆盖：M6.1→L6.1 + 博物馆 2020-12-04、2022-04-30、2022-06-01、2022-09-30、2023-02-25、2024-02-06、2025-05-02；M6.2→L6.2 + 博物馆 2024-11-21、2026-01-14、2026-05 气费砸币、2026-05 DKG 未落盘；M6.3→L6.3 + Block-STM 工作实例（不变量 122）+ Quorum Store ≠ 排序（不变量 132）；M6.4+M6.5→L6.4（含 J 节；Avalanche 对照的是抽样，C-Chain 事故见不变量 119）。
