...
来源：合并 `cursor/cometbft-echousage-notdone-676-2f0b`（KB 最全）+ 本优化迭代（677–1114 Query/CheckTx/Commit/InitChain/Finalize/ProposalStatus/Prepare/Apply/Offer Result 拆句；1115–1559 BIP-44/43/85/49/48/45/67/86/89/383/386/381/382/387/371/388/384/385/328/373/87/129/88/78/69/94/325/127/137/70/38/13/321/322/352/353/47/30/147 账户发现、用途层、导出熵、嵌套找回、多签层次、联合签名人发现、确定性地址、单钥 P2TR、链码委托、多签描述符、tr 树、非隔离见证放置、隔离见证压缩、tapscript 多签、Taproot 工作包栏、钱包策略、combo、raw/addr 包装、MuSig2 聚合钥派生、MuSig2 工作包栏、BIP-87 多签路径、BIP-129 安全开户、BIP-88 路径模板、BIP-78 payjoin、BIP-69 字典序、BIP-94 Testnet 4、BIP-325 signet、BIP-127 储备证明、BIP-137 旧式签消息、BIP-70 付款协议、BIP-38 加密私钥、BIP-13 付给脚本哈希地址、BIP-321 付款 URI、BIP-322 通用签消息、BIP-352 静默付款、BIP-353 DNS 付款名、BIP-47 付款码通知、BIP-30 重复交易标识 与 BIP-147 空 dummy、BIP-155 后继地址、BIP-130 头通告偏好、BIP-133 费率过滤器、BIP-338 停交易转发、BIP-434 功能协商、BIP-339 按 wtxid 转发、BIP-330 通告集合对账、BIP-159 有限历史服务、BIP-144 带见证对等服务、BIP-111 布隆服务位、BIP-35 内存池查询、BIP-61 拒收反馈、BIP-31 pong 探活、BIP-14 协议版本、BIP-324 第 2 版传输、BIP-157 客户端侧过滤、BIP-158 基本过滤器、EIP-8 向前兼容、EIP-2124 分叉标识、EIP-778 节点记录、EIP-868 发现要记录、EIP-100 叔块难度、EIP-150 读树涨价、EIP-658 收据状态、PrepareUsage rawmust、PrepareNochecks、PrepareWhen collect、PrepareWhen return、SuggestValidate、LateUnverified、LateMay、VerifyDiscard、VerifyCall、VerifyStatusWhen、VerifyKeep、VerifyAcceptDef、ProcAcceptDef、ExtWhenBcast、EIP-2 Homestead、ExtAppGen、CiNotes、ExtCiNotes、CiFields、ExecTxEv、ExtViUse、PrepEv、ValUse、ViAvail、EIP-7 DELEGATECALL、EIP-140 REVERT、EIP-214 STATICCALL、EIP-211 returndata、EIP-1014 CREATE2、EIP-1052 EXTCODEHASH、EIP-1344 CHAINID、EIP-3198 BASEFEE、EIP-7516 BLOBBASEFEE、EIP-145 SHIFT、EIP-3855 PUSH0、EIP-5656 MCOPY、EIP-3529 refund、EIP-6049 deprecate、EIP-2200 net-meter、EIP-2028 calldata-cut、EIP-2565 modexp-price、EIP-1108 bn128-cut、EIP-1884 SELFBALANCE、EIP-152 BLAKE2F、EIP-3860 initcode、EIP-170 returned、EIP-3541 reserved-prefix、EIP-3651 coinbase、EIP-2929 cold-vs-warm、EIP-2930 listed、EIP-2718 typed-envelope、EIP-7935 default-gas、EIP-7825 tx-gas-cap、EIP-7934 rlp-cap、EIP-7623 calldata-floor、EIP-7939 clz、EIP-7823 modexp-bound、EIP-7928 block-list、EIP-7044 exit-domain、EIP-7917 lookahead、EIP-1559 basefee-vs-tip、EIP-7642 history-window、EIP-4844 blob-fee、EIP-7691 blob-schedule、EIP-7918 blob-reserve、EIP-2935 history-hash、EIP-7892 bpo、EIP-4788 parent-root、AnyTrust dacert、Celestia nmt、EIP-4844 blob-vs-das、assumevalid、policy-vs-consensus、BIP-125 rbf-signal、BIP-112 csv、BIP-65 cltv、BIP-16 p2sh、BIP-173 bech32、BIP-350 bech32m、BIP-34 coinbase-height、BIP-9 versionbits、BIP-66 strict-DER、BIP-141 txid-wtxid、BIP-341 Taproot、BIP-342 tapscript 拆句）。  
