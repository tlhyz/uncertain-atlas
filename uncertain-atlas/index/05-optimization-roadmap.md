...
来源：合并 `cursor/cometbft-echousage-notdone-676-2f0b`（KB 最全）+ 本优化迭代（677–1114 Query/CheckTx/Commit/InitChain/Finalize/ProposalStatus/Prepare/Apply/Offer Result 拆句；1115–1192 BIP-44/43/85/49/48/45/67/86/89/383/386/381/382/387/371/388/384/385/328/373/87/129/88/78/69/94 账户发现、用途层、导出熵、嵌套找回、多签层次、联合签名人发现、确定性地址、单钥 P2TR、链码委托、多签描述符、tr 树、非隔离见证放置、隔离见证压缩、tapscript 多签、Taproot 工作包栏、钱包策略、combo、raw/addr 包装、MuSig2 聚合钥派生、MuSig2 工作包栏、BIP-87 多签路径、BIP-129 安全开户、BIP-88 路径模板、BIP-78 payjoin、BIP-69 字典序与 BIP-94 Testnet 4 拆句）。  
