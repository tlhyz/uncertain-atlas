...
来源：合并 `cursor/cometbft-echousage-notdone-676-2f0b`（KB 最全）+ 本优化迭代（677–721 Query/CheckTx/Commit/InitChain/Finalize/ProposalStatus/Prepare/ApplySnapshotChunk Result 拆句）。  
