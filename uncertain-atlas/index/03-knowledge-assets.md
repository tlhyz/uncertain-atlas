...
| 07 | 《Design Pattern Library》 | `libraries/design-patterns/` | 40 条 | 重要 |
| 08 | 《Anti-Pattern Library》 | `libraries/anti-patterns/` | 147 条 | 重要 |
...
| 12 | 《不确定 Invariant Library》 | `libraries/invariants/` | 146 条 | 必学 |
| 13 | 《不确定 Adversarial Test Corpus》 | `libraries/adversarial-corpus/` | 目录 C01–C150；runner 未建 | 重要 |
...
| Cosmos / CometBFT | 2 | 必学 | 第一版；IBC 客户端 ≠ 数据包（不变量 146） |
