...
| 08 | 《Anti-Pattern Library》 | `libraries/anti-patterns/` | 20 条 | 重要 |
...
| 编号 | 资产 | 路径 | 状态 | 优先级 |
|---|---|---|---|---|
| 09 | 《后量子区块链工程手册》 | `tracks/post-quantum/` | FIPS 名义长度 + 有状态 HBS 卡；CPU 空 | 研究级 |
| 10 | 《不确定协议设计决策库》 | `libraries/decision-matrix/` | 对照列已扩；候选列空 | 重要 |
| 11 | 《不确定威胁模型》 | `libraries/threat-model/` | 草稿 | 必学 |
| 12 | 《不确定 Invariant Library》 | `libraries/invariants/` | 17 条 | 必学 |
| 13 | 《不确定 Adversarial Test Corpus》 | `libraries/adversarial-corpus/` | 目录 C01–C19；runner 未建 | 重要 |
