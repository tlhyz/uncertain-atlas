...
| 03 | 《共识协议图谱》 | `tracks/consensus/` + `tracks/finality/` | 对照表 + ABCI 四门 + 扩展 + 集合延迟 + PBTS 块时间 | 必学 |
...
| 08 | 《Anti-Pattern Library》 | `libraries/anti-patterns/` | 43 条 | 重要 |
...
| 12 | 《不确定 Invariant Library》 | `libraries/invariants/` | 40 条 | 必学 |
| 13 | 《不确定 Adversarial Test Corpus》 | `libraries/adversarial-corpus/` | 目录 C01–C42；runner 未建 | 重要 |
