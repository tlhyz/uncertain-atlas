...
| 04 | 《状态模型图谱》 | `tracks/state-models/` + `tracks/parallelism/` | 进行中；Block-STM 工作实例（不变量 122） | 必学 |
...
| 07 | 《Design Pattern Library》 | `libraries/design-patterns/` | 21 条 | 重要 |
| 08 | 《Anti-Pattern Library》 | `libraries/anti-patterns/` | 130 条 | 重要 |
...
| 12 | 《不确定 Invariant Library》 | `libraries/invariants/` | 127 条 | 必学 |
| 13 | 《不确定 Adversarial Test Corpus》 | `libraries/adversarial-corpus/` | 目录 C01–C131；runner 未建 | 重要 |
