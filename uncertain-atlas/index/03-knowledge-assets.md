...
| 07 | 《Design Pattern Library》 | `libraries/design-patterns/` | 50 条 | 重要 |
| 08 | 《Anti-Pattern Library》 | `libraries/anti-patterns/` | 157 条 | 重要 |
...
| 12 | 《不确定 Invariant Library》 | `libraries/invariants/` | 156 条 | 必学 |
| 13 | 《不确定 Adversarial Test Corpus》 | `libraries/adversarial-corpus/` | 目录 C01–C160；runner 未建 | 重要 |
...
| Ethereum | 3 | 重要 | 第一版；blob gas ≠ 执行气（不变量 145）；处理完一块 ≠ 已经改规范头（不变量 149）；提款操作 ≠ 用户交易（不变量 154）；父信标根 ≠ 当前头（不变量 156） |
