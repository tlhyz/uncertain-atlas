...
| 03 | 《共识协议图谱》 | `tracks/consensus/` + `tracks/finality/` | 对照表 + ABCI 四门 + vote extension | 必学 |
| 04 | 《状态模型图谱》 | `tracks/state-models/` + `tracks/parallelism/` | 进行中 | 必学 |
| 05 | 《区块链密码学地图》 | `tracks/crypto/` | 对照表 + 域分离三层编码精读 | 必学 |
| 05b | 《实现保证精读》 | `tracks/implementation/` | 编码 + 崩溃 + assumevalid + 头工作量 | 必学 |
...
| 编号 | 资产 | 路径 | 状态 | 优先级 |
|---|---|---|---|---|
| 06 | 《区块链失败博物馆》 | `tracks/failure-museum/` | 十案 + 17144 五层精读 | 必学 |
| 07 | 《Design Pattern Library》 | `libraries/design-patterns/` | 15 条 | 重要 |
| 08 | 《Anti-Pattern Library》 | `libraries/anti-patterns/` | 37 条 | 重要 |
...
| 12 | 《不确定 Invariant Library》 | `libraries/invariants/` | 34 条 | 必学 |
| 13 | 《不确定 Adversarial Test Corpus》 | `libraries/adversarial-corpus/` | 目录 C01–C36；runner 未建 | 重要 |
