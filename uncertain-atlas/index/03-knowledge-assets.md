...
| 03 | 《共识协议图谱》 | `tracks/consensus/` + `tracks/finality/` | 对照表 + ABCI 四门精读 | 必学 |
...
| 08 | 《Anti-Pattern Library》 | `libraries/anti-patterns/` | 36 条 | 重要 |
...
| 12 | 《不确定 Invariant Library》 | `libraries/invariants/` | 33 条 | 必学 |
| 13 | 《不确定 Adversarial Test Corpus》 | `libraries/adversarial-corpus/` | 目录 C01–C35；runner 未建 | 重要 |
