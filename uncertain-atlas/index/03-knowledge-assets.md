...
| 编号 | 资产 | 路径 | 状态 | 优先级 |
|---|---|---|---|---|
| 06 | 《区块链失败博物馆》 | `tracks/failure-museum/` | 九案 + 17144 五层精读 | 必学 |
| 07 | 《Design Pattern Library》 | `libraries/design-patterns/` | 15 条 | 重要 |
| 08 | 《Anti-Pattern Library》 | `libraries/anti-patterns/` | 34 条 | 重要 |
...
| 12 | 《不确定 Invariant Library》 | `libraries/invariants/` | 31 条 | 必学 |
| 13 | 《不确定 Adversarial Test Corpus》 | `libraries/adversarial-corpus/` | 目录 C01–C33；runner 未建 | 重要 |
