...
- 抽样委员会若存在，签名域必须独立（已经是不变式 19 的亲戚）；罚没条件若没有，就不要在文档里写「和验证者同一刀」。Casper 证明/提议那一刀见 [`../economic/worked-example-casper-slashing.md`](../economic/worked-example-casper-slashing.md)。
