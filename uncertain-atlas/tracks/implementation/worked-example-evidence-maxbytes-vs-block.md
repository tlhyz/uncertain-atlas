...
**不要写进**：Ethereum 行、L5.1、M5.4、L5.4、03 共识图谱、Bitcoin 行。本页是「填了证据 MaxBytes 不是已经落在块上限下面 / > 0 不是已经盖住解绑 / 证据 MaxBytes 不是已经是块 MaxBytes」，不是先装证据已经装满交易，也不是默认证据窗已经够罚。不要另写怎样设 EvidenceParams.MaxBytes 或怎样算块开销。
