...
不要抄控制块长度 / 叶子版本 / annex 字节 / NUMS 点。不要写怎样藏一条别人看不见的脚本路径。不编博物馆页。不另写 19 节。BIP-342 Tapscript 操作码、BIP-340 标签公式、BIP-143 签名摘要、annex 当产品功能标成另一对象。
...
**边界：** 不讲 Tapscript 操作码。不抄控制块数字。不另写 19 节。不写怎样藏脚本。BIP-342 / annex 产品语义 / NUMS 另标。
