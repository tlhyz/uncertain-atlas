...
**不要写进**：Ethereum 行、L5.1、M5.4、L5.4、03 共识图谱、Bitcoin 行、L4.5。本页是「Prepare 没有确定性要求不是已经必须确定 / 两边 raw 一样不是已经是同一份提案 / ExtendVote 没有确定性要求不是已经是同一份扩展」，不是四门已经结算，也不是立刻整块执行已经离开关键路径。不要另写怎样写 Prepare 或怎样写 ExtendVote。
