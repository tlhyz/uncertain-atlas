...
先装证据 ≠ 已经装满交易；两条收交易上限 ≠ 已经同一条：[`worked-example-evidence-vs-reap.md`](worked-example-evidence-vs-reap.md)（MaxBytes 写成 -1 ≠ 已经没有上限；不变量 299）。填了证据 MaxBytes ≠ 已经落在块上限下面：[`../implementation/worked-example-evidence-maxbytes-vs-block.md`](../implementation/worked-example-evidence-maxbytes-vs-block.md)（不变量 331）。看见 > 0 不是已经盖住解绑。看见证据 MaxBytes 不是已经是块 MaxBytes。  
