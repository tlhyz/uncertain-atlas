...
> 亲戚：扩展快路径跳过普通票字段检查 → 接收节点 panic，见 [ASA-2024-011](../failure-museum/asa-2024-011.md)（不变量 57）。治理改启用高度必须先过转移谓词，见 [ASA-2024-001](../failure-museum/asa-2024-001.md)（不变量 58）。提议者注入的扩展不是投票权预言机，见 [ASA-2024-006](../failure-museum/asa-2024-006.md)（不变量 68）。
