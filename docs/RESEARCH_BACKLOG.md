...
| P1-11 | Full 65d Binance tick backtest SOXL/SNXX | in_progress | ~168 min (~2h48m); DUAL_REPORT pending — checkpoint 0430Z |
...
| P2-02 | BTC leverage scan 1.25/1.5/1.75/2.0 | in_progress | ~107 min; ~25min/level est; CRYPTO_REPORT pending — checkpoint 0430Z |
