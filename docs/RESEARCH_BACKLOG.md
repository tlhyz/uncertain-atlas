...
| P3-03 | Short structure dir vs grid vs 70/30 | **in_progress** | 2/4 grid running; directional=-58.70% (≡ default); tmux p3-03-short-structures |
...
| P3-07 | SOXL/SNXX weight 75/25 70/30 65/35 | pending | config dual_binance_tick_soxl_snxx_weights.yaml ready; queue after P3-06 |
...
|----|------|--------|---------|
| M-01 | Run `pytest -q` | done | 138 passed 2026-09-13T21:20Z |
