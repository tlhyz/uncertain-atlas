...
| P0-06 | Phase 1.5 infra gates (DATA_QUALITY, accounting, leak tests) | in_progress | TASK-0008/0009 done; TASK-0010 pending |
...
|----|------|--------|---------|
| M-01 | Run `pytest -q` | pending | every session start |
