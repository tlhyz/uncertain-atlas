...
| P1-11 | Full 65d Binance tick backtest SOXL/SNXX | in_progress | 130+ min (~2h10m); DUAL_REPORT pending |
...
| P2-02 | BTC leverage scan 1.25/1.5/1.75/2.0 | in_progress | 70+ min; still on leverage scan (4 levels × 2184 bars) |
