...
| P2-02 | BTC leverage scan 1.25/1.5/1.75/2.0 | in_progress | ~287 min (~4h47m); 99.9% CPU — checkpoint 0730Z |
| P2-03 | ETH leverage scan | **in_progress** | 2.0x running (~159min total) |
...
| P2-05 | Grid ATR step 0.30–0.60 sweep | **in_progress** | ~139min |
| P2-06 | Grid range ±3/5/7 ATR sweep | **in_progress** | ~119min |
| P2-07 | Grid→Trend mix 80/20→20/80 | **in_progress** | ~108min; 80_20 running |
