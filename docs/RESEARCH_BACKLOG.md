...
| ID | Task | Status | Log / notes |
|----|------|--------|-------------|
| P4-01 | Independent vs unified 10k portfolio | **in_progress** | 1/2 portfolios ~20min — outputs/review_logs/2026-09-14_P4-01_independent_vs_unified_IN_PROGRESS.md |
