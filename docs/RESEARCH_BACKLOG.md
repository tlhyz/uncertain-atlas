...
| P2-05 | Grid ATR step 0.30–0.60 sweep | **in_progress** | ~270min; 4 steps, no variant log yet |
| P2-06 | Grid range ±3/5/7 ATR sweep | **in_progress** | ~250min; 3 ranges, no variant log yet |
| P2-07 | Grid→Trend mix 80/20→20/80 | **in_progress** | ~218min; 80_20/60_40 done; 50_50 ~21min — outputs/review_logs/2026-09-13_P2-07_btc_grid_mix_IN_PROGRESS.md |
...
| P2-14 | CRYPTO_C1 window 2024-09→11 tick run | **in_progress** | tmux p2-14-c1-tick ~160min — outputs/review_logs/2026-09-13_P2-14_c1_tick_IN_PROGRESS.md |
