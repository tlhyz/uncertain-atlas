...
| P2-02 | BTC leverage scan 1.25/1.5/1.75/2.0 | in_progress | ~297 min (~4h57m); 99.9% CPU — checkpoint 0740Z |
| P2-03 | ETH leverage scan | **in_progress** | 2.0x running (~169min total) |
