...
| P2-02 | BTC leverage scan 1.25/1.5/1.75/2.0 | **in_progress** | 1.25x **-87.47%** done ~109min; 1.5x running — outputs/review_logs/2026-09-13_P2-02_btc_leverage_RESTART.md |
