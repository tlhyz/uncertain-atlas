...
| P1-11 | Full 65d Binance tick backtest SOXL/SNXX | in_progress | ~179 min (~2h59m); DUAL_REPORT pending — checkpoint 0440Z |
...
| P2-02 | BTC leverage scan 1.25/1.5/1.75/2.0 | in_progress | ~117 min (~1h57m); CRYPTO_REPORT pending — checkpoint 0440Z |
| P2-03 | ETH leverage scan | **in_progress** | started 04:40Z tmux p2-03-eth-leverage; klines+91d aggTrades ready |
