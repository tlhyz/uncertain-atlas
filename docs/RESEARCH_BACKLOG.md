...
| P1-11 | Full 65d Binance tick backtest SOXL/SNXX | in_progress | 150+ min (~2h30m); DUAL_REPORT pending |
...
| P2-02 | BTC leverage scan 1.25/1.5/1.75/2.0 | in_progress | 90+ min; leverage scan still running (~22min/level) |
