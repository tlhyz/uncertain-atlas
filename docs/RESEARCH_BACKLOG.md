...
| P2-02 | BTC leverage scan 1.25/1.5/1.75/2.0 | in_progress | ~327 min (~5h27m); 6h kill ~08:43Z (~16min) — checkpoint 0810Z |
...
| P2-05 | Grid ATR step 0.30–0.60 sweep | **in_progress** | ~179min |
| P2-06 | Grid range ±3/5/7 ATR sweep | **in_progress** | ~159min |
| P2-07 | Grid→Trend mix 80/20→20/80 | **in_progress** | ~148min; 60_40 running |
...
| P2-14 | CRYPTO_C1 window 2024-09→11 tick run | **in_progress** | tmux p2-14-c1-tick ~79min — outputs/review_logs/2026-09-13_P2-14_c1_tick_IN_PROGRESS.md |
