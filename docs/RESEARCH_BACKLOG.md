...
| P2-02 | BTC leverage scan 1.25/1.5/1.75/2.0 | in_progress | ~177 min (~2h57m); CRYPTO_REPORT pending — checkpoint 0540Z |
| P2-03 | ETH leverage scan | **in_progress** | 1.25x done -87.86%; 1.5x running (~49min) |
| P2-04 | SOL leverage scan | **in_progress** | 1.25x–1.75x -88.01%; 2.0x running |
| P2-05 | Grid ATR step 0.30–0.60 sweep | **in_progress** | ~29min |
| P2-06 | Grid range ±3/5/7 ATR sweep | **in_progress** | ~10min |
| P2-07 | Grid→Trend mix 80/20→20/80 | **in_progress** | runner+config; tmux p2-07-btc-grid-mix — outputs/review_logs/2026-09-13_P2-07_btc_grid_mix_IN_PROGRESS.md |
