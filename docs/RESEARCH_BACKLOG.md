...
| P1-11 | Full 65d Binance tick backtest SOXL/SNXX | in_progress | 140+ min (~2h20m); DUAL_REPORT pending |
...
| P2-02 | BTC leverage scan 1.25/1.5/1.75/2.0 | in_progress | 80+ min; ~20min/level on 2184 tick bars |
