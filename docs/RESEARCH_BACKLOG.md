...
| P3-03 | Short structure dir vs grid vs 70/30 | **in_progress** | 1/4 directional ~21min; tmux p3-03-short-structures |
| P3-04 | Drawdown set A/B/C comparison | pending | config ready; queue after P3-03 |
| P3-06 | Right-side reserve 25/30/35% | pending | config dual_binance_tick_right_side_reserve.yaml ready; queue after P3-04 |
...
|----|------|--------|---------|
| M-01 | Run `pytest -q` | done | 137 passed 2026-09-13T21:10Z |
