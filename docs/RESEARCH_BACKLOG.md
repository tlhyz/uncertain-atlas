...
| P2-02 | BTC leverage scan 1.25/1.5/1.75/2.0 | **in_progress** | RESTART 08:40Z; 1.25x ~100min; baseline ~100min/level — outputs/review_logs/2026-09-13_P2-02_btc_leverage_RESTART.md |
...
| P2-05 | Grid ATR step 0.30–0.60 sweep | **in_progress** | ~320min; 4 steps, no variant log yet |
| P2-06 | Grid range ±3/5/7 ATR sweep | **in_progress** | ~300min; 3 ranges, no variant log yet |
| P2-07 | Grid→Trend mix 80/20→20/80 | **in_progress** | ~268min; 80_20/60_40 done; 50_50 ~81min — outputs/review_logs/2026-09-13_P2-07_btc_grid_mix_IN_PROGRESS.md |
...
| P2-14 | CRYPTO_C1 window 2024-09→11 tick run | **in_progress** | tmux p2-14-c1-tick ~220min — outputs/review_logs/2026-09-13_P2-14_c1_tick_IN_PROGRESS.md |
