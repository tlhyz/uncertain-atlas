...
| P1-11 | Full 65d Binance tick backtest SOXL/SNXX | in_progress | 120+ min; DUAL_REPORT pending |
...
| P2-02 | BTC leverage scan 1.25/1.5/1.75/2.0 | in_progress | 51+ min; 4 levels × 2184 tick bars (~12min/level) |
