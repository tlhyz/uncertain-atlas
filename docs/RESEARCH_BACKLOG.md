...
| P2-02 | BTC leverage scan 1.25/1.5/1.75/2.0 | **in_progress** | RESTART 08:40Z; 1.25x ~60min (~40% slower than ETH) — outputs/review_logs/2026-09-13_P2-02_btc_leverage_RESTART.md |
...
| P2-14 | CRYPTO_C1 window 2024-09→11 tick run | **in_progress** | tmux p2-14-c1-tick ~180min — outputs/review_logs/2026-09-13_P2-14_c1_tick_IN_PROGRESS.md |
