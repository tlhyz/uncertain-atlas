...
| **G50** | **-57.85%** | **-1.96** | **+0.85pp better (best)** |
| G25 | -64.97% | -2.37 | −6.27pp worse |
| dynamic | — | — | running 5/5 (~20min) |
...
| **G50** | **-57.85%** | **-1.96** | **+0.85pp better (best)** |
| G25 | -64.97% | -2.37 | −6.27pp worse |
| dynamic | — | — | running 5/5 (~3min) |

**Finding:** Monotonic less-grid trend **breaks at G25** (−64.97%). **G50 is sweet spot** on this window, not pure directional.
