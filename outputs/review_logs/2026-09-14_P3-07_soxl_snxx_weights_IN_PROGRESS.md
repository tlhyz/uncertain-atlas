...
| **70/30** | **-58.70%** | -1.88 | baseline match ✓ |
| 65/35 | — | — | running 3/3 (~17min) |
...
| **75/25** | **-58.89%** | -1.89 | −0.19pp worse |
| **70/30** | **-58.70%** | -1.88 | **baseline match** ✓ |
| 65/35 | — | — | running 3/3 (~3min) |

**Finding:** Default 70/30 reproduces P3-01 exactly. Higher SOXL (75/25) slightly worse.
