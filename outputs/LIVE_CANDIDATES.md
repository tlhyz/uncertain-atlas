...
> **No high-confidence live deployment yet.** Baselines below are **research candidates only**.
...
**Gate OOS calibration required** before raising confidence.

**Tech Short→Long:** not a live candidate until beats Cash→Long on Binance ticks + Gate OOS.
